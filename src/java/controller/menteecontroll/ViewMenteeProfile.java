 ...
 * @author okanh
 */
public class ViewMenteeProfile extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id=request.getParameter("accmenteeid");
        String mess=request.getParameter("mess");
        int menteeid=Integer.parseInt(id);
        MenteeDAO dao=new MenteeDAO();
        Mentee mentee=dao.getMenteebyAccID(menteeid);
        AccountDAO daoa=new AccountDAO();
        Account acc=daoa.getAccountByid(menteeid);
        if(mess!=null){
        if(!mess.trim().equals("")){
