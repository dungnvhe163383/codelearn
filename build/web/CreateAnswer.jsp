<%-- 
    ...
    Created on : Mar 22, 2023, 8:24:10 AM
    Author     : okanh
--%>

<%-- 
    Document   : UpdateAnswer
    Created on : Mar 22, 2023, 7:51:11 AM
    Author     : okanh
--%>
                ...
                <section class="breadcrumbs">
                 ...
                 <c:if test="${done !=null}">
                        ...
                        <c:if test="${error !=null}">
                            ...
                            <form class="" action="CreateAnswer?mentorid=${sessionScope.getmentor.id}&requestid=${sessionScope.coderequest.id}" method="post" style="position: relative">
                    <div class="cr" >
