<%-- 
    ...
    Created on : Mar 20, 2023, 12:51:03 AM
    Author     : okanh
--%>
    ...
    <body>    
        <c:if test="${sessionScope.account.roleid==1}">
            <jsp:include page="guest/Header.jsp"></jsp:include>
                 ...
                 <c:if test="${done !=null}">
                    ...
                    <div class="cr" >
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input name="title" type="text" class="form-control form-control-lg" value="${sessionScope.coderequest.title}" >   
                        </div>
                        <!-- Password input -->
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <c:forEach items="${sessionScope.skill}" var="sk">${sk.name} , </c:forEach><br>
                            <label class="form-label">Choose Skill :</label><br>
                            <c:forEach items="${sessionScope.listallskill}" var="s">
                        ...
                        <div class="form-outline mb-3" >
                            ...
                            <textarea name="content" rows="4" class="form-control form-control-lg" >${sessionScope.coderequest.content}</textarea>
                        </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <c:forEach items="${sessionScope.listallmentor}" var="l">
                                            <div class="testimonial-item swiper-slide">
                                                ...
                                                <input type="checkbox" name="choosementor" value="${l.id}"/>
                                            </div>
                                        </c:forEach>                            
                                    </div>
               ...
               <button onclick='window.history.go(-1);' class="btn btn-outline-primary btn-lg" style="position: absolute;bottom: 0px;left: 20px;">Back</button>
