<%-- 
    Document   : MyRequest
    Created on : Mar 19, 2023, 2:00:39 PM
    Author     : okanh
--%>
    ...
    <body>
        <c:if test="${sessionScope.account.roleid==1}">
                         ...
                         <table class="table table-striped table-hover" style=" margin: 50px; width:93%">
                             <tr>
                                 ...
                                 <tr>
                                     ...
                                     <td>${c.costhire}</td>                                      
                                     <td>${c.status}</td> 
                                     <td><form action="EditHireRequest?hirereid=${c.id}" method="post">
            ...
            <ul class="pagination" style="display: flex;justify-content: center;align-items: center;  ">
                ...
                <li class="page-item">
                    <a class="page-link" href="ViewHireAllRequest?index=${tag+1}&menteeid=${sessionScope.getmentee.id}" aria-label="Next">
