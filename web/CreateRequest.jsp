                ...
                <section class="breadcrumbs">
                 ...
                 <c:if test="${done !=null}">
                        ...
                        <c:if test="${error !=null}">
                            ...
                            <form class="" action="CreateRequest?menteeid=${sessionScope.getmentee.id}" method="post">
                    <div class="cr" >
                        <div class="col-md-6 col-lg-6 col-xl-4 offset-xl-1" style="height: 600px; ">
                            <h2 class="text-center text-primary fw-bold">New Request</h2>                                   
                        <!-- Username input -->
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <input name="deadline" type="date" class="form-control form-control-lg"required>
                        </div>
                        <div class="form-outline mb-3">
                            <label class="form-label">Skill:</label><br>
                            <c:forEach items="${listallskill}" var="s">
